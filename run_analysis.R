#Creating Directory and loading the libraries

rm(list = ls(all = TRUE))
require(plyr)
library(data.table) # a package that handles data frame better
library(dplyr) # for data table manipulations and organization
